      ...
      <header className="navbar">
        <div className="navbar-inner">
          <div className="header-titles">
            ...
            <div>
              <h1>Roster</h1>
              <p className="navbar-subtitle">Personnel records &amp; payroll</p>
            </div>
          </div>
      ...
      <div className="container">
        ...
        <div className="toolbar">
          <div className="search-wrap">
            ...
            <input
              ...
              placeholder="Find a record — name or department"
              value={searchQuery}
            ...
            <form onSubmit={editingId ? saveEdit : addEmployee} className="form-grid">
              ...
              <div className="form-actions">
                ...
                <button type="submit" className={editingId ? "btn-save" : "btn-add"}>
                  ...
                  {editingId ? "Save Changes" : "File Record"}
                </button>
              </div>
            </form>
          </div>
        ...
        {visibleEmployees.length === 0 ? (
          <div className="empty-state">
            <Users size={32} />
            <p className="empty-msg">No records match that search.</p>
          </div>
        ) : (
            ...
            {visibleEmployees.map((employee) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="id-stamp">EMP-{String(employee.id).padStart(3, "0")}</p>
